    ...
    return (
        <form className='form'>
            <div className='form__loginInput'>
                <input type="text" placeholder={'Identifier'} value={identifier} onChange={(e) => setIdentifier(e.target.value)} />
                <input type="password" placeholder={'Password'} value={password} onChange={(e) => setPassword(e.target.value)} />
                <button className="login" onClick={(e) => handleLogin(e)}>Valid</button>
            </div>
        </form>
    )
}
